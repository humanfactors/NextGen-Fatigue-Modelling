...
//To get these the calculations of S and C, L processes above must go in the "transformed parameters"
// section rather than the model section. However they are included in the model section above
//to avoid storing all sequential values of S, C, L etc. (these values can be recalculated using
//estimated model parameters, time of day and sleep history as required)
